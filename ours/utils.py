...
def vel_unnormalizer(normalized_vel):
    ...
    '''
    vel_mean = torch.tensor([-4.906372733478189e-06, -0.0003581614249505887], 
                            device=normalized_vel.device, dtype=normalized_vel.dtype)
    vel_std = torch.tensor([0.0018492343327724738, 0.0018154400863548657], 
                           device=normalized_vel.device, dtype=normalized_vel.dtype)
...
def vel_normalizer(vel):
    ...
    Multi:
    [-7.015138177866919e-07, -0.0003254785057079781]
    [0.001120946572619328, 0.001372354098173555]

    Goop:
    [6.839056577087033e-06, -0.0008123306585070839]
    [0.0017002050274650662, 0.002129137009516546]

    Sand:
    [5.123277536458455e-06, -0.0009965205918140803]
    [0.0021978993231675805, 0.0026653552458701774]

    Water:
    [-4.906372733478189e-06, -0.0003581614249505887]
    [0.0018492343327724738, 0.0018154400863548657]
    '''
    vel_mean = torch.tensor([-4.906372733478189e-06, -0.0003581614249505887], 
